...
class combat(Pokemon):
    ...
    def loser(self):
        print()
        if self.pokemon1.hp() <= 0: # pokemon1 KO, loser = pokemon2
            print('Perdant du combat:', self.pokemon1.name(), '...')
        elif self.pokemon2.hp() <= 0: # pokemon2 KO, loser = pokemon1
    ...
    # get the type of the ennemy andapply the multiplacator


    def get_type(self):
        if type(self.pokemon2) == Eau: 
            if type(self.pokemon1) == Feu: 
                self.pokemon1.atk = self.pokemon1.atk * 0.5
            elif type(self.pokemon1) == Plante: 
                self.pokemon1.atk = self.pokemon1.atk * 2
            elif type(self.pokemon1) == Normal:
                self.pokemon1.atk = self.pokemon1.atk * 0.75
            else:
                self.pokemon1.atk = self.pokemon1.atk * 1
        elif type(self.pokemon2) == Feu: 
            if type(self.pokemon1) == Eau: 
                self.pokemon1.atk = self.pokemon1.atk * 2
            elif type(self.pokemon1) == Plante: 
                self.pokemon1.atk = self.pokemon1.atk * 0.5
            elif type(self.pokemon1) == Normal:
                ...
                self.pokemon1.atk = self.pokemon1.atk * 1
        elif type(self.pokemon2) == Plante: 
            if type(self.pokemon1) == Eau: 
                self.pokemon1.atk = self.pokemon1.atk * 0.5
            elif type(self.pokemon1) == Feu: 
                self.pokemon1.atk = self.pokemon1.atk * 2
            elif type(self.pokemon1) == Normal: 
                self.pokemon1.atk = self.pokemon1.atk * 0.75
            else:
